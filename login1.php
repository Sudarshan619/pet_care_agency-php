...
if (isset($_POST['email'])) {
    ...
    $statement = $dbConnection->prepare("SELECT id, first_name, last_name, phone, password FROM login_details WHERE email = ?");
    ...
    $statement->bind_result($id, $first_name, $last_name, $phone, $hashed_password);
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
		  <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex">
			<li class="nav-item px-2">
			    <a class="btn btn-primary me-2" href="login1.php">Login</a>
			</li>
			<li class="nav-item px-2">
			    <a class="btn btn-outline-primary" href="register1.php">Register</a>
			</li>
		  </ul>
		</div>
	  </div>
