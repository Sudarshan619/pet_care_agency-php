...
if (isset($_POST['first_name'])) {
    ...
    do {
        ...
        $dbConnection = new mysqli("localhost", "root", "sudu123", "pets");

        //Let use prepared statements to avoid "sql injection attacks"
        $statement = $dbConnection->prepare("SELECT id FROM login_details WHERE email = ?");
        ...
        //Let use prepared statements to avoid "sql injection attacks"
        $statement = $dbConnection->prepare("INSERT INTO login_details(id,first_name, last_name, email, phone, password) VALUES (null,?, ?, ?, ?, ?)");

        // Bind variables to the prepared statement as parameters
        $statement->bind_param('sssss', $first_name, $last_name, $email, $phone, $hashed_password);
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
		  <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex">
			<li class="nav-item px-2">
			    <a class="btn btn-outline-primary me-2" href="login1.php">Login</a>
			</li>
			<li class="nav-item px-2">
			    <a class="btn btn-primary" href="register1.php">Register</a>
			</li>
		  </ul>
		</div>
	  </div>
